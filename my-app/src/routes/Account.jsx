  ...
  function ab_tr_email() {
    ...
    for (var i = 0; i < localStorage.length; i++) {
      if (localStorage.getItem(email) === null) {
        alert("Não existe esse email no nosso banco de dados!");
        return;
      }
    }
  ...
  return (
    <div>
      ...
      <div className="principal">
        ...
        <h1 className="texto1" style={{ fontSize: "49px" }}>
          Minha Conta
        </h1>
      ...
      <div id="modal1" className="modal hide">
        ...
        <div className="botao">
          <button onClick={conferir} className="botaoc">
            {" "}
            Confirmar
          </button>
          <button onClick={fe_tr_email} className="botaoca">
            {" "}
            Cancelar
          </button>
        </div>
      ...
      <div id="modal2" className="modal12">
        ...
        <div className="botao">
          <button onClick={conferir_s} className="botaoc">
            {" "}
            Confirmar
          </button>
          <button onClick={fe_tr_senha} className="botaoca">
            {" "}
            Cancelar
          </button>
        </div>
