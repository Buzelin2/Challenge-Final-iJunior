  ...
  let artista1, artista2, artista3, artista4, artista5, artista6, artista7, artista8, artista9, artista10, topmusicas;
  ...
  apiSpotify.get("/artists/06HL4z0CvFAxyc27GXpf02?si=2f5d50325251476e/top-tracks").then((response) => { topmusicas = response.data });
